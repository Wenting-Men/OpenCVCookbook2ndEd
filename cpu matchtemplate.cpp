...
int main()
{
	...
	// read the image
	Mat image = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
	...
	/*	cout << k << " of " << n << endl;*/
		...
		image0 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		if (!image0.data)
			return 0;
		...
		image1 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		// using .ptr and * ++
		tinit = getTickCount();
		colorReduce1(image1);
		t[1] += getTickCount() - tinit;

		image2 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		// using .ptr and * ++ and modulo
		tinit = getTickCount();
		colorReduce2(image2);
		t[2] += getTickCount() - tinit;

		image3 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		// using .ptr and * ++ and bitwise
		tinit = getTickCount();
		colorReduce3(image3);
		t[3] += getTickCount() - tinit;

		image4 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		// using direct pointer arithmetic
		tinit = getTickCount();
		colorReduce4(image4);
		t[4] += getTickCount() - tinit;

		image5 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		// using .ptr and * ++ and bitwise with image.cols * image.channels()
		tinit = getTickCount();
		colorReduce5(image5);
		t[5] += getTickCount() - tinit;

		image6 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		// using .ptr and * ++ and bitwise (continuous)
		tinit = getTickCount();
		colorReduce6(image6);
		t[6] += getTickCount() - tinit;

		image7 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		// using .ptr and * ++ and bitwise (continuous+channels)
		tinit = getTickCount();
		colorReduce7(image7);
		t[7] += getTickCount() - tinit;

		image8 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		// using Mat_ iterator
		tinit = getTickCount();
		colorReduce8(image8);
		t[8] += getTickCount() - tinit;

		image8b = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		// using Mat_ iterator
		tinit = getTickCount();
		colorReduce8b(image8b);
		t[15] += getTickCount() - tinit;

		image9 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		// using Mat_ iterator and bitwise
		tinit = getTickCount();
		colorReduce9(image9);
		t[9] += getTickCount() - tinit;

		image10 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		// using Mat_ iterator
		tinit = getTickCount();
		colorReduce10(image10);
		t[10] += getTickCount() - tinit;

		image11 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		// using at
		tinit = getTickCount();
		colorReduce11(image11);
		t[11] += getTickCount() - tinit;

		image12 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		...
		image13 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		// using overloaded operators
		tinit = getTickCount();
		colorReduce13(image13);
		t[13] += getTickCount() - tinit;

		image14 = imread("C:\\Users\\Crystal008\\Desktop\\lena.jpg");
		// using overloaded operators
		tinit = getTickCount();
